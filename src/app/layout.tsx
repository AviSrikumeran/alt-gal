...
/**
 * Studio chrome type (D-143 as amended by D-243). Instrument Sans and IBM Plex Mono, under chrome-only
...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="en" className={`${studioSans.variable} ${studioMono.variable}`}>
      <body>
        {children}
